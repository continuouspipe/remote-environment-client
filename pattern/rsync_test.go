...
func TestRsyncPathPattern_Match(t *testing.T) {
	scenarios := []struct {
		...
		{
			"/Users/bob/dev/proj/path/to/file/DIFFERENT",
			[]string{"/abc**"},
		...
		},
		{
			"/Users/bob/dev/proj/path/to/file/DIFFERENT",
			[]string{"abc**"},
			"double star pattern at the end of a not anchored pattern should not match",
			"",
			true,
			nil,
		},
		{
			"/Users/bob/dev/proj/path/to/file/abc",
			[]string{"abc**"},
			"double star pattern at the end of a not anchored pattern should match",
			"Not transferring /Users/bob/dev/proj/path/to/file/abc because of pattern abc**",
			false,
			nil,
		},
		{
